...
const startTmpl = require('../views/oauth/registration.start');
const oauthTmpl = require('../views/oauth/registration.oauth');
const sucTmpl = require('../views/oauth/registration.success');

...
export default {
  ...
  mounted() {
    ...
    this.imageSrc = `//img.youtube.com/vi/${this.url}/${imageSize}.jpg`
    this.iframeSrc = `//www.youtube.com/embed/${
      this.url
    }?rel=0&showinfo=0&autoplay=1&frameborder=0&color=white&controls=0&disablekb=0&fs=0&modestbranding=1&html5=1`

    console.log('this', this.imageSrc)
    const currentYT = this.$el
